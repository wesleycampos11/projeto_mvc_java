...
<meta name="theme-color" content="#4b70e2" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
</head>
<body>
 <div class="main">
          <div class="acontainer a-container" id="a-container">
            <form class="form" method="post" action="CadastrarUsuario">
              ...
              <span class="form__span">CPF ou use o e-mail para inscrição</span>
              <input class="form__input" type="text" placeholder="Nome:"  name="nome" id="nome_login"  maxlength="60" required=""/>
              <input class="form__input" type="tel" placeholder="CPF:" name="cpf" id="cliente_cadastrar"  maxlength="11" required=""/>
              <input class="form__input" type="text" placeholder="Email:" name="email" id="email_login" maxlength="50" required=""/>
              <input class="form__input" type="password" placeholder="Senha:" name="senha" id="senha" minlength="4"  maxlength="12" required="" />
              <button class="form__button switch__button button" type="submit">
                INSCREVA-SE
              </button>
              <a class="form__button switch__button button" href="index.html">VOLTAR</a>
            </form>
          </div>
          <div class="acontainer b-container" id="b-container">
            <form class="form" method="post" action="Logar">
              <h2 class="form_title switch__button title">Entrar</h2>
              <div class="form__icons">
                <img
                  class="form__icon"
                  src="data:image/svg+xml;base64,"
              ...
              <input class="form__input" type="text" placeholder="Email" name="email" id="email_login" maxlength="50" required="" />
              <input class="form__input" type="password" placeholder="Senha"  name="senha" id="senha_login" minlength="4" maxlength="12" required=""/> 
              <a class="form__link" href="EsqueceuSuaSenha.jsp" >Esqueceu sua senha?</a>
              <button class="form__button switch__button button" type="submit">
                ENTRAR
              </button>
              
             <strong class="form_link">
				<%
          ...
          <div class="switch" id="switch-cnt">
            ...
            <div class="switch__container" id="switch-c1">
              <h2 class="switch__title">Bem vindo!</h2>
              <p class="switch__description description">
                Para se manter conectado conosco, faça login com suas
                informações pessoais
              </p>
              <button class="switch__button2 button switch-btn">ENTRAR</button>
            </div>
            <div class="switch__container is-hidden" id="switch-c2">
              ...
              <button class="switch__button2 button switch-btn">
                INSCREVER-SE
              </button>
            </div>
          </div>
